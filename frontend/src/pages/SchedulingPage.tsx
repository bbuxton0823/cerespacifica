        ...
        <div className="h-screen flex flex-col bg-slate-50 overflow-hidden">
            ...
            <header className="bg-white/80 backdrop-blur-md border-b border-slate-200 px-6 py-4 flex justify-between items-center z-10">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button className="px-4 py-2 bg-blue-600 text-white rounded-lg text-sm font-medium hover:bg-blue-700 shadow-sm shadow-blue-200 transition-all flex items-center gap-2">
                    ...
                    <div className="bg-white rounded-2xl p-5 shadow-sm border border-slate-100">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <span className="text-sm font-bold text-blue-600 bg-blue-50 px-2 py-0.5 rounded-full">45</span>
                            </div>
                            <div className="flex justify-between items-center">
